import { BedrockAgentCoreClient, StartBrowserSessionCommand, StopBrowserSessionCommand, GetBrowserSessionCommand, ListBrowserSessionsCommand, UpdateBrowserStreamCommand, } from '@aws-sdk/client-bedrock-agentcore';
...
export class Browser {
    ...
    async getSession(params) {
        ...
        if (!browserId || !sessionId) {
            throw new Error('Browser ID and Session ID must be provided or available from current session. ' +
     ...
     * ```
     */
    async updateBrowserStream(params) {
        const browserId = params.browserId ?? this.identifier;
        const sessionId = params.sessionId ?? this._session?.sessionId;
        if (!browserId || !sessionId) {
            throw new Error('Browser ID and Session ID must be provided or available from current session. ' +
